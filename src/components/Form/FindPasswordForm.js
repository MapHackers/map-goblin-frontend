    ...
    <div>
      {!typePassword ? (
            ...
            setTimeout(() => {
              ...
              axios
                ...
                .then((response) => {
                  ...
                  axios
                    .post(`/api/email`, dataToSubmitEmail)
                    .then((response) => {
        ...
        <Formik
          ...
          validationSchema={Yup.object().shape({
            password: Yup.string().required('비밀번호를 입력 해주세요.'),
          ...
          onSubmit={(values, { setSubmitting }) => {
            setTimeout(() => {
              ...
              axios
                .post(`/api/members/${userId}/password`, dataToSubmit, {
                  headers: {
        ...
        <Formik
          ...
          validationSchema={Yup.object().shape({
            code: Yup.string().required('이메일을 확인하여 코드를 입력해 주세요'),
          })}
          onSubmit={(values, { setSubmitting }) => {
            setTimeout(() => {
              let dataToSubmit = {
              ...
              axios
                .post(`/api/checkNumber`, dataToSubmit)
                .then((response) => {
