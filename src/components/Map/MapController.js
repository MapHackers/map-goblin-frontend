        ...
        <>
            {authority === "OWNER" &&
                <Controller onClick={MarkerOnClick}>
                    <img style={{ width: '100%', height: '100%', backgroundColor: isMarkerCreatable ? 'rgba(0,100,255, 0.2)' : 'whitesmoke', boxShadow: '2px 2px 2px 2px gray' }} src="../../MintLogo.png" alt="Logo" />
                </Controller>
            }
